...
///
#ifndef _tools_to_string_hpp_INCLUDED_
#define _tools_to_string_hpp_INCLUDED_
...
namespace tools{
	...
	std::string to_string(Container const& list, char separator = ','){
