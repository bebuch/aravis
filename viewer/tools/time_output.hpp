/// \file tools/time_output.hpp
/// \author Benjamin Buch (benni.buch@gmail.com)
/// \date 18.11.2014
/// \brief template function tools::time_output
///
...
///
#ifndef _tools_time_output_hpp_INCLUDED_
#define _tools_time_output_hpp_INCLUDED_
...
namespace tools{
	...
	inline std::basic_ostream< CharT, Traits >& time_output(std::basic_ostream< CharT, Traits >& os, std::chrono::system_clock::time_point const& time = std::chrono::system_clock::now()) {
	...
	inline std::basic_string< CharT, Traits, Allocator > time_output(std::chrono::system_clock::time_point const& time = std::chrono::system_clock::now()) {
	...
	inline std::string time_output(std::chrono::system_clock::time_point const& time = std::chrono::system_clock::now()) {
		return time_output< char >(time);
	}
