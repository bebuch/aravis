//
// http_server_callback_file_request_handler.cpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// Copyright (c) 2014 Benjamin Buch (benni dot buch at googlemail dot com)
//
// Distributed under the Boost Software License, Version 1.0. (See accompanying
// file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
//

#include "server_callback_file_request_handler.hpp"
...
namespace http { namespace server {
	...
	bool callback_file_request_handler::handle_request(connection_ptr const& connection, http::request const& req, http::reply& rep) {
