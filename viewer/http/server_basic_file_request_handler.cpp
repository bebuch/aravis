//
// http_server_basic_file_request_handler.cpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
namespace http { namespace server {
	...
	void basic_file_request_handler::set_http_header(http::request const& req, http::reply& rep, std::string const& mime_type)const{
		rep.headers.clear();
